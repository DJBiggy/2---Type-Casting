 ...
 */
let mixedCollection: [Any] = [3.14, 42, "Hello", true, 7, "World", false, 1.618]
...
for element in mixedCollection {
    if let intValue = element as? Int {
        ...
        print("Unexpected type in the collection")
    }
}
...
for (_, value) in mixedDictionary {
    if let intValue = value as? Int {
        ...
        total2 += doubleValue
              ...
              let stringToDouble = Double(stringValue) {
        total2 += stringToDouble
    }
}
